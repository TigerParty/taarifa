						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="col-2"><?php echo Kohana::lang('ui_main.report_edit');?></th>
							...
							<?php
								...
								foreach ($incidents as $incident)
								{
									...
									?>
									<tr>
										<td class="col-1" style="width:5px;">
										...
										<td class="col-4">
											<ul> 
												<li class="none-separator" style="padding:0px;" ><a href="#" id="link<?php echo $incident_id; ?>" enable="<?php echo $incident_enable; ?>" <?php if ($incident_enable == 1) { echo "class=\"status_yes\""; } else {  echo "class=\"status_no\"";  }?>  onclick="reportHideAction('v', '<?php echo $incident_id; ?>');"><?php if ($incident_enable == 1) { echo "ENABLE"; } else {  echo "DISABLED"; }?></a></li> 
											</ul> 
										</td>
									</tr>
									<?php
