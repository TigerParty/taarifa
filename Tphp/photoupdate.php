...
{   
  $strSQL = sprintf("delete from media where incident_id = %s",$idReport); 
  $strSQL2 = sprintf("insert into media(media_type,media_link,media_medium,media_thumb,media_date, incident_id, location_id )values(1,'%s','%s','%s','%s', '%s', '$s')",
