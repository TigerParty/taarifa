		...
		<div class="rapidxwpr floatholder">
			...
			<div class="footermenu">
				<ul class="clearingfix">
					...
					<li style="display:none;"><a href="<?php echo url::site()."alerts"; ?>"><?php echo Kohana::lang('ui_main.alerts'); ?></a></li>
					<li style="display:none;"><a href="<?php echo url::site()."contact"; ?>"><?php echo Kohana::lang('ui_main.contact'); ?></a></li>
					<?php
